...
import { ChevronLeft, ChevronRight, Star, Clock, Calendar, Film, Users, Globe, Info } from "lucide-react";
			...
			<div className="mx-auto container px-4 py-20 h-full">
				...
				{trailers.length > 0 && (
					<div className="relative">
						...
						<div className="flex justify-between items-center mb-4 absolute top-1/2 left-0 right-0 px-4">
							<button
								className={`
								bg-gray-800/80 hover:bg-red-600 text-white p-3 rounded-full shadow-lg transition-all duration-300 ${
				...
				<div className="flex flex-col md:flex-row items-start justify-between gap-8 max-w-6xl mx-auto bg-gray-900/70 rounded-xl p-6 shadow-xl">
					...
					<div className="flex-1">
						<h2 className="text-4xl md:text-5xl font-bold text-balance">{content?.title || content?.name}</h2>
